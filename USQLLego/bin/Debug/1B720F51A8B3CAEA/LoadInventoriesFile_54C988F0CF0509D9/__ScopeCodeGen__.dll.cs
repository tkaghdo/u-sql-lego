			...
			{
				{
					...
					exceptionIndex++;
					output.SetInternal<System.Int32>(1, (col_INVENTORY_VERSION));
					exceptionIndex++;
					output.SetInternal<System.String>(2, (col_SET_NUMBER.IndexOf(staticconstant_0) >= 0 ? col_SET_NUMBER.Substring(0, col_SET_NUMBER.IndexOf(staticconstant_0)) : col_SET_NUMBER));
					exceptionIndex++;
					output.SetInternal<System.String>(3, (col_SET_NUMBER.IndexOf(staticconstant_1) >= 0 ? col_SET_NUMBER.Substring(col_SET_NUMBER.IndexOf(staticconstant_1) + 1) : null));
					exceptionIndex++;
				}
			}
			catch (Exception exception)
