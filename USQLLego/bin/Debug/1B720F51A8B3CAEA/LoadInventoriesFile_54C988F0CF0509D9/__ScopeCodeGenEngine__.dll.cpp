...
// Explicit instantiations for templated functions that are defined in managed code
    ...
    INLINE ostream & operator<<(ostream & os, Extract_0_Data0 & row)
    {
        ...
        os << "\t" << std::string{ u8"INVENTORY_VERSION" } << ":\t" << row.m_INVENTORY_VERSION << endl;
    ...
    struct ManagedRow<Extract_0_Data0>
    {
        cli::array<ScopeEngineManaged::ColumnOffsetId>^ ColumnOffsets()
        {
            ...
            offset[1] = ColumnOffsetId(offsetof(Extract_0_Data0, m_INVENTORY_VERSION), T_Integer);
            offset[2] = ColumnOffsetId(offsetof(Extract_0_Data0, m_SET_NUMBER), T_String);
            return offset;        
        }
        ...
        cli::array<ScopeEngineManaged::SqlIpColumn^>^ Columns(cli::array<String^>^ readOnlyColumns)
        {
            ...
            c[1] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("INVENTORY_VERSION"), System::Int32::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("INVENTORY_VERSION")) >= 0, /*isSystem*/false);
            c[2] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_NUMBER"), System::String::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_NUMBER")) >= 0, /*isSystem*/false);
            return c;        
        }
    ...
    struct ManagedRow<Process_1_Data0>
    {
        cli::array<ScopeEngineManaged::ColumnOffsetId>^ ColumnOffsets()
        {
            ...
            offset[1] = ColumnOffsetId(offsetof(Process_1_Data0, m_INVENTORY_VERSION), T_Integer);
            offset[2] = ColumnOffsetId(offsetof(Process_1_Data0, m_SET_PREFIX), T_String);
            offset[3] = ColumnOffsetId(offsetof(Process_1_Data0, m_SET_POSTFIX), T_String);
            return offset;        
        }
        ...
        cli::array<ScopeEngineManaged::SqlIpColumn^>^ Columns(cli::array<String^>^ readOnlyColumns)
        {
            ...
            c[0] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("INVENTORY_ID"), System::Int32::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("INVENTORY_ID")) >= 0, /*isSystem*/false);
            c[1] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("INVENTORY_VERSION"), System::Int32::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("INVENTORY_VERSION")) >= 0, /*isSystem*/false);
            c[2] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_PREFIX"), System::String::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_PREFIX")) >= 0, /*isSystem*/false);
            c[3] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_POSTFIX"), System::String::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_POSTFIX")) >= 0, /*isSystem*/false);
            return c;        
        }
...
// project, and then turn off /doc.
            ...
            m_SET_NUMBER(c.m_SET_NUMBER, alloc)
    {
        ...
        m_INVENTORY_VERSION = c.m_INVENTORY_VERSION;
    }
        ...
        static bool Deserialize(TextInputStream<TextInputStreamTraitsConst<',', '\0', '\0', false, true, UTF8, true, false, false, 1, CharFormat_uint16>, CosmosInput> * input, Extract_0_Data0 & row)
        {
            for(;;)
            {
                try
                {
                    ...
                    input->Read(row.m_INVENTORY_VERSION);
...
// project, and then turn off /doc.
    ...
    public:
        ...
        static bool FilterTransformRow(Extract_0_Data0 & input, Process_1_Data0 & output, IncrementalAllocator * alloc)
        {
           ...
           output.m_INVENTORY_VERSION = input.m_INVENTORY_VERSION;
            return true;
        }
...
// project, and then turn off /doc.
    ...
    public:
        ...
        {
            ScopeManagedInterop::CopyToNativeColumn(nativeRow.m_SET_PREFIX, managedRow->GetInternal<System::String^>(2), alloc);
            ScopeManagedInterop::CopyToNativeColumn(nativeRow.m_SET_POSTFIX, managedRow->GetInternal<System::String^>(3), alloc);
        }
    };
#endif // defined(COMPILE_MANAGED)
// All of the templates will throw a CS1591 warning because we 
...
// project, and then turn off /doc.
    ...
    public:
        ...
        static void Serialize(TextOutputStream<TextOutputStreamTraitsConst<',', '\0', false, false, true, false, true, UTF8, true, CharFormat_uint16>, CosmosOutput> * output, Process_1_Data0 & row)
        {
            ...
            output->Write<int,false>(row.m_INVENTORY_VERSION);
            output->WriteDelimiter();
        ...
        static void SerializeHeader(TextOutputStream<TextOutputStreamTraitsConst<',', '\0', false, false, true, false, true, UTF8, true, CharFormat_uint16>, CosmosOutput> * output)
        {
            ...
            output->WriteDelimiter();
            output->Write<string,true>(FString("INVENTORY_VERSION", 17));
            output->WriteDelimiter();
