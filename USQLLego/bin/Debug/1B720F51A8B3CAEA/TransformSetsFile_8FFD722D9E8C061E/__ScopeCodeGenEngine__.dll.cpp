...
// Explicit instantiations for templated functions that are defined in managed code
    ...
    {
        os << "\t" << std::string{ u8"SET_NUMBER" } << ":\t" << row.m_SET_NUMBER << endl;
        os << "\t" << std::string{ u8"SET_NAME" } << ":\t" << row.m_SET_NAME << endl;
        os << "\t" << std::string{ u8"SET_YEAR" } << ":\t" << row.m_SET_YEAR << endl;
        os << "\t" << std::string{ u8"SET_THEME" } << ":\t" << row.m_SET_THEME << endl;
        os << "\t" << std::string{ u8"NUMBER_OF_PARTS" } << ":\t" << row.m_NUMBER_OF_PARTS << endl;
        return os;
    }
#endif // defined(SCOPE_DEBUG)
    ...
    {
    public:
        FString m_SET_PREFIX;
        FString m_SET_POSTFIX;
        FString m_SET_NAME;
        int m_SET_YEAR;
        FString m_SET_THEME;
        int m_NUMBER_OF_PARTS;
    ...
    {
        os << "\t" << std::string{ u8"SET_PREFIX" } << ":\t" << row.m_SET_PREFIX << endl;
        os << "\t" << std::string{ u8"SET_POSTFIX" } << ":\t" << row.m_SET_POSTFIX << endl;
        os << "\t" << std::string{ u8"SET_NAME" } << ":\t" << row.m_SET_NAME << endl;
        os << "\t" << std::string{ u8"SET_YEAR" } << ":\t" << row.m_SET_YEAR << endl;
        os << "\t" << std::string{ u8"SET_THEME" } << ":\t" << row.m_SET_THEME << endl;
        os << "\t" << std::string{ u8"NUMBER_OF_PARTS" } << ":\t" << row.m_NUMBER_OF_PARTS << endl;
    ...
    struct ManagedRow<Extract_0_Data0>
    {
        cli::array<ScopeEngineManaged::ColumnOffsetId>^ ColumnOffsets()
        {
            ...
            offset[0] = ColumnOffsetId(offsetof(Extract_0_Data0, m_SET_NUMBER), T_String);
            offset[1] = ColumnOffsetId(offsetof(Extract_0_Data0, m_SET_NAME), T_String);
            offset[2] = ColumnOffsetId(offsetof(Extract_0_Data0, m_SET_YEAR), T_Integer);
            offset[3] = ColumnOffsetId(offsetof(Extract_0_Data0, m_SET_THEME), T_String);
            offset[4] = ColumnOffsetId(offsetof(Extract_0_Data0, m_NUMBER_OF_PARTS), T_Integer);
            return offset;        
        }
        ...
        cli::array<ScopeEngineManaged::SqlIpColumn^>^ Columns(cli::array<String^>^ readOnlyColumns)
        {
            ...
            c[0] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_NUMBER"), System::String::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_NUMBER")) >= 0, /*isSystem*/false);
            c[1] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_NAME"), System::String::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_NAME")) >= 0, /*isSystem*/false);
            c[2] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_YEAR"), System::Int32::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_YEAR")) >= 0, /*isSystem*/false);
            c[3] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_THEME"), System::String::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_THEME")) >= 0, /*isSystem*/false);
            c[4] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("NUMBER_OF_PARTS"), System::Int32::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("NUMBER_OF_PARTS")) >= 0, /*isSystem*/false);
            return c;        
        }
    ...
    struct ManagedRow<Process_1_Data0>
    {
        cli::array<ScopeEngineManaged::ColumnOffsetId>^ ColumnOffsets()
        {
            ...
            offset[0] = ColumnOffsetId(offsetof(Process_1_Data0, m_SET_PREFIX), T_String);
            offset[1] = ColumnOffsetId(offsetof(Process_1_Data0, m_SET_POSTFIX), T_String);
            offset[2] = ColumnOffsetId(offsetof(Process_1_Data0, m_SET_NAME), T_String);
            offset[3] = ColumnOffsetId(offsetof(Process_1_Data0, m_SET_YEAR), T_Integer);
            offset[4] = ColumnOffsetId(offsetof(Process_1_Data0, m_SET_THEME), T_String);
            offset[5] = ColumnOffsetId(offsetof(Process_1_Data0, m_NUMBER_OF_PARTS), T_Integer);
            return offset;        
        }
        ...
        cli::array<ScopeEngineManaged::SqlIpColumn^>^ Columns(cli::array<String^>^ readOnlyColumns)
        {
            ...
            c[0] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_PREFIX"), System::String::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_PREFIX")) >= 0, /*isSystem*/false);
            c[1] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_POSTFIX"), System::String::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_POSTFIX")) >= 0, /*isSystem*/false);
            c[2] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_NAME"), System::String::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_NAME")) >= 0, /*isSystem*/false);
            c[3] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_YEAR"), System::Int32::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_YEAR")) >= 0, /*isSystem*/false);
            c[4] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("SET_THEME"), System::String::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("SET_THEME")) >= 0, /*isSystem*/false);
            c[5] = gcnew ScopeEngineManaged::SqlIpColumn(gcnew System::String("NUMBER_OF_PARTS"), System::Int32::typeid, readOnlyColumns == nullptr ? false : Array::IndexOf(readOnlyColumns, gcnew System::String("NUMBER_OF_PARTS")) >= 0, /*isSystem*/false);
            return c;        
        }
...
// project, and then turn off /doc.
    ...
    INLINE Extract_0_Data0::Extract_0_Data0(const Extract_0_Data0 & c, IncrementalAllocator * alloc) :
            m_SET_NUMBER(c.m_SET_NUMBER, alloc),
            m_SET_NAME(c.m_SET_NAME, alloc),
            m_SET_THEME(c.m_SET_THEME, alloc)
    {
        m_SET_YEAR = c.m_SET_YEAR;
        m_NUMBER_OF_PARTS = c.m_NUMBER_OF_PARTS;
    }
        ...
        static bool Deserialize(TextInputStream<TextInputStreamTraitsConst<',', '\0', '\0', false, true, UTF8, true, false, false, 1, CharFormat_uint16>, CosmosInput> * input, Extract_0_Data0 & row)
        {
            for(;;)
            {
                try
                {
                    ...
                    input->Read(row.m_SET_NUMBER);
                    input->Read(row.m_SET_NAME);
                    input->Read(row.m_SET_YEAR);
                    input->Read(row.m_SET_THEME);
                    input->Read(row.m_NUMBER_OF_PARTS);
...
// project, and then turn off /doc.
    ...
    public:
        ...
        {
           output.m_SET_YEAR = input.m_SET_YEAR;
           output.m_SET_THEME = input.m_SET_THEME;
           output.m_NUMBER_OF_PARTS = input.m_NUMBER_OF_PARTS;
            return true;
        }
...
// project, and then turn off /doc.
    ...
    public:
        ...
        {
            ScopeManagedInterop::CopyToNativeColumn(nativeRow.m_SET_PREFIX, managedRow->GetInternal<System::String^>(0), alloc);
            ScopeManagedInterop::CopyToNativeColumn(nativeRow.m_SET_POSTFIX, managedRow->GetInternal<System::String^>(1), alloc);
            ScopeManagedInterop::CopyToNativeColumn(nativeRow.m_SET_NAME, managedRow->GetInternal<System::String^>(2), alloc);
        }
    };
#endif // defined(COMPILE_MANAGED)
// All of the templates will throw a CS1591 warning because we 
...
// project, and then turn off /doc.
    ...
    public:
        ...
        {
            if (!row.m_SET_PREFIX.IsNull())
            {
                output->Write<FString,true>(row.m_SET_PREFIX);
            }
            output->WriteDelimiter();
            if (!row.m_SET_POSTFIX.IsNull())
            {
                output->Write<FString,true>(row.m_SET_POSTFIX);
            }
            output->WriteDelimiter();
            if (!row.m_SET_NAME.IsNull())
            {
                output->Write<FString,true>(row.m_SET_NAME);
            }
            output->WriteDelimiter();
            output->Write<int,false>(row.m_SET_YEAR);
            output->WriteDelimiter();
            if (!row.m_SET_THEME.IsNull())
            {
                output->Write<FString,true>(row.m_SET_THEME);
            }
            output->WriteDelimiter();
            output->Write<int,false>(row.m_NUMBER_OF_PARTS);
            output->WriteNewLine();
        }
        ...
        {
            output->Write<string,true>(FString("SET_PREFIX", 10));
            output->WriteDelimiter();
            output->Write<string,true>(FString("SET_POSTFIX", 11));
            output->WriteDelimiter();
            output->Write<string,true>(FString("SET_NAME", 8));
            output->WriteDelimiter();
            output->Write<string,true>(FString("SET_YEAR", 8));
            output->WriteDelimiter();
            output->Write<string,true>(FString("SET_THEME", 9));
            output->WriteDelimiter();
            output->Write<string,true>(FString("NUMBER_OF_PARTS", 15));
            output->WriteNewLine();
        }
    };
